      ...
      child: Flex(
          ...
          children: [
            ...
            Expanded(
              ...
              items: [
                ProjectWidget(title: "Lawyer App"),
                ProjectWidget(title: "Task Management"),
                ProjectWidget(title: "Corona-Live-Tracking"),
                ProjectWidget(title: "Git Profile Checker"),
                ProjectWidget(title: "Chatify"),
              ],
              height: 170,
